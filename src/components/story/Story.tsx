...
const CreateMyStory = () => {
    ...
    return (
        <>
        <Link to={`/stories`} onClick={() => dispatch(setCreateStory())} className="w-[53px] border-[2px] relative flex flex-col items-center justify-center bg-gradient-to-r from-red-500 to-pink-600 h-[53px] cursor-pointer rounded-full">
